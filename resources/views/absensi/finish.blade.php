                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">Terimakasih sudah mendaftar sebagai peserta Itikaf</h2>
                                                <h4 class="text-center">Silahkan Ambil Kartu anggota anda di Panitia masjid Al-Ikhlas Dukuh Bima</h4>
                                                <h4 class="text-center">Informasi lebih lanjut Hubungi Admin</h4>
                                                {{--<a href="#" class="text-center">Chat Admin</a>--}}
                                            </div>
                                        </div>
                                        <button class="btn-danger float-right p-2 align-center">Kembali</button>
                                    </div>
                                </div>
