        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="nestable-menu" class="m-b-10">
                    {!! link_to_route(config('quickadmin.route').'.jamaah.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
                </div>
                        ...
                        <table class="table table-striped table-bordered nowrap datatable" id="datatable">
                            ...
                            @foreach ($jamaah as $row)
                                <tr>
                                    ...
                                    <td>
                                        {!! link_to_route(config('quickadmin.route').'.jamaah.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-xs btn-info')) !!}
