        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="nestable-menu" class="m-b-10">
                    {!! link_to_route(config('quickadmin.route').'.slider1.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
                </div>
                        ...
                        <table class="table table-striped table-hover table-responsive datatable" id="datatable">
                            ...
                            @foreach ($slider1 as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->title }}</td>
                                    <td>@if($row->image != '')<img class="img-responsive" width="250px" src="{{ asset('uploads') . '/'.  $row->image }}">@endif</td>

                                    <td>
                                        {!! link_to_route(config('quickadmin.route').'.slider1.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-xs btn-info')) !!}
                                        {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('quickadmin.route').'.slider1.destroy', $row->id))) !!}
